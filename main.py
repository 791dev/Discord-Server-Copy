...
def display_banner():
    ...
    print(Fore.YELLOW + "\n\t\tSunucu Kopyalayıcı - mermireal Tarafından Yapılmıştır\n" + Style.RESET_ALL)
...
if __name__ == "__main__":
    clear_screen()
    TO_GUILD = input(Fore.CYAN + "Yapıştırılacak sunucu ID (Yapıştırılacak sunucu):\n> " + Style.RESET_ALL)
    FROM_GUILD = input(Fore.CYAN + "Kopyalanacak sunucu ID (Kopyalanacak sunucu):\n> " + Style.RESET_ALL)
